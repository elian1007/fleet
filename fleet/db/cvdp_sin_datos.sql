...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-10-2022 a las 22:21:43
...
--
ALTER TABLE `costos_viaje`
  ADD CONSTRAINT `costos_viaje_ibfk_1` FOREIGN KEY (`id_linea`) REFERENCES `lineas` (`id_linea`),
  ADD CONSTRAINT `costos_viaje_ibfk_2` FOREIGN KEY (`origen`) REFERENCES `ciudades` (`codigo`),
  ADD CONSTRAINT `costos_viaje_ibfk_3` FOREIGN KEY (`destino`) REFERENCES `ciudades` (`codigo`);
...
ALTER TABLE `dev_remision`
  ...
  ADD CONSTRAINT `dev_remision_ibfk_2` FOREIGN KEY (`id_remision`) REFERENCES `remisiones` (`id_remision`),
...
ALTER TABLE `remisiones`
  ...
  ADD CONSTRAINT `remisiones_ibfk_2` FOREIGN KEY (`codigo_ciudad`) REFERENCES `ciudades` (`codigo`),
